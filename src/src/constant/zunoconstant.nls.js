...
/*-------------------------------*/
	START_NOT_SUPPORT: `Not support platform '${Os.platform()}' and CPU architecture '${Os.arch()}'`,
	START_KEY_QUESTION: 'Want to customize keyboard shortcuts for Z-Uno?',
	START_KEY_FIND: 'To sort in: \'Z-Uno\'',
	START_UPDATE_NEW_VERSION: 'New version released Z-Uno',
	START_UPDATE_LATER: 'Later remind',
...
/*-------------------------------*/
	...
	INSTALL_INVALID_CORE: 'There seem to be some problems with the installed components. Reinstall them!',
/*-------------------------------*/
...
/*-------------------------------*/
	CPP_TOOLS_ADD_CONFIG: 'In order for Z-Uno to work with IntelliSense there was an added configuration of ${name}, now you need to choose what would become current',
...
/*-------------------------------*/
	...
	SERIALMONITOR_CURRENTOPTIONS_NOT_UPLOAD: 'As long as the port used by the monitor is used for loading, you cannot configure the monitor',
	...
	SERIALMONITOR_OPTIONS_BAUDRATE_CHANGE: 'Failed to change data rate',
	SERIALMONITOR_OPTIONS_BAUDRATE_DECRIPTION: 'Data rate',
	SERIALMONITOR_OPTIONS_BAUDRATE_MANUAL: 'Point to manual...',
	SERIALMONITOR_OPTIONS_BAUDRATE_MANUAL_PLACEHOLDER: 'Enter the data rate manually',
...
/*-------------------------------*/
	...
	UPLOAD_SELECT_PORT: 'You need to choose a serial port',
